...
const TONES = {
  ...
  /* Console tones. EventStatus and AttendanceStatus come out of the
     database as SCREAMING_SNAKE; a badge is where they become English. */
...
/** EventStatus -> badge tone. One mapping, used by both consoles. */
